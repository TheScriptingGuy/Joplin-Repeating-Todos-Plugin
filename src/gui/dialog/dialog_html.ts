/** Dialog markup **********************************************************************************************************************************
 * The recurrence dialog's form markup, kept in one place so that the plugin and the e2e tests drive exactly the same HTML.                        *
 *                                                                                                                                                 *
 * `RECURRENCE_DATA` is a placeholder: openDialog() replaces it with the base64-encoded recurrence JSON before handing the HTML to Joplin. The     *
 * dialog's addon script (dialog_addon.js) decodes it on load and writes the user's edits back into the same hidden field, which is what Joplin    *
 * returns as form data when the dialog is accepted.                                                                                               *
 ***************************************************************************************************************************************************/
    ...
    <fieldset id="weekFieldset">
        ...
        <table>
            ...
            <tr>
                ...
                <td><label for="weekSaturdayCheckbox">Saturday</label></td>
            </tr>
        </table>
    </fieldset>
